...
class LeftPanel(QWidget):
    ...
    def update_view(self, card: Card):
        ...
        if card.is_month_card():
            ...
            self.__bsRaLabel.setText("" if monthly.has_check_in() else monthly.vehicle.plate_number)
            self.__fee_label.setText("")
            ...
            self.__card_info_labels["T/G XE RA"].setText("" if singleCard.has_check_in() else str(singleCard.card_log.exit_at))
