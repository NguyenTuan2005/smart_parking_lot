...
class CustomerService:
    ...
    def search_customers(self, keyword: str, is_active: int = 1) -> List[CustomerViewDTO]:
        try:
            ...
            for dto in all_customers:
                if (keyword_lower in dto.customer_name.lower() or
                    keyword_lower in (dto.phone_number or "") or
                    keyword_lower in (dto.plate_number.lower() or "") or
                    keyword_lower in (dto.email.lower() or "")):
                    filtered.append(dto)
